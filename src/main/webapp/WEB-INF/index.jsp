	...
	<body> 
		<div class="jumbotron jumbotron-fluid">
	        <div class="container">
	            ...
	            <p class="lead">Lab206 members hub to share tech information</p>
	        </div>
        </div>
		          	...
		          	<div class="row">
             			<div class="col-md-6">
				            ...
				            <form:select path ="skill">
				                ...
				                <form:option value="JS">JS</form:option>
          ...
          <div id="tools" align='right'>
            <nav>
              <ul>
                ...
                <li><a href="https://learn.codingdojo.com/signin" target="_blank">CodingDojo</a></li>
